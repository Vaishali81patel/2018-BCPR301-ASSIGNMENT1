...
class InterpreterController(Cmd):
    ...
    def do_add(self, *args):
        ...
        # Written By: Patel
        """*** OPTIONS
                    -l : This option loads the employee info from a file.
                        The file is given to the command as a string.
                    -m : This option does manual data entry. \
                        The user will be prompted  \
                        for step by step employee information to \
    ...
    def do_save(self, *args):
        ...
        #
        """*** OPTIONS
                        -s : This option is a standard save. \
                            The information is saved to a file \
                            in the existing program files.
                        -d : This option saves the current \
                            employee information to the database.
                        -f : This option saves a file to \
    ...
    def do_show(self, *args):
        ...
        #
        """*** OPTIONS
                    -a : This option shows a bar graph \
                    ...
                    -c : This option shows a scatter plot graph \
                        of peoples age verse their salary.
                    -d : This option shows a pie chart of the \
                        BMI of a set of people.
        ***"""
        options_arr = self.parse_args(args)
        option_dict = {
    ...
    def do_manual_emp_data_entry(self):
        ...
        # Written By: Patel
        #
        self.my_interpreter.manual_data_entry(
            self, my_view.manual_emp_data_flow())
