...
import sys
import os
# Import os Executing a shell command os.system function Get the users environment os.
...
class CLI(cmd.Cmd):
    ...
    def do_add(self, s):
        ...
        print ("""***DATA FORMAT:
                    ...
                    AGE............[0-9]{2}  e.x.: 28  
                    SALES..........[0-9]{3} e.x.: 100  
                    BMI............(Normal|Overweight|Obesity|Underweight) e.x.: Normal
                    SALARY.........[0-9]{2-3} e.x.: 200
                    BIRTHDAY.......[1-31]-[1-12]-[0-9]{4} e.x.: 1990-10-21' """)
    ...
    def do_show(self, s):
        print ('show command displays the current working employee information in a specified format.')
        print ('USAGE:')
